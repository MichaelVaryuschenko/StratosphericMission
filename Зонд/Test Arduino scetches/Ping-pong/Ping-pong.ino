...
const int PIN_LORA_RESET = 8;  // LORA RESET
const int PIN_LORA_NSS = 10;    // LORA SPI CS
const int PIN_LORA_SCLK = 13;  // LORA SPI CLK
const int PIN_LORA_MISO = 12;  // LORA SPI MISO
const int PIN_LORA_DIO_1 = 3; // LORA DIO_1
const int PIN_LORA_BUSY = 4;  // LORA SPI BUSY
const int PIN_LORA_MOSI = 11;  // LORA SPI MOSI
const int RADIO_TXEN = 2;     // LORA ANTENNA TX ENABLE
const int RADIO_RXEN = 7;     // LORA ANTENNA RX ENABLE
